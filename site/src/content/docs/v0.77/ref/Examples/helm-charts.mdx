---
title: helm-charts
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/helm-charts/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/helm-charts
---

:::note
To view the full example, as well as its dependencies, please visit [examples/helm-charts](https://github.com/zarf-dev/zarf/tree/main/examples/helm-charts).
:::

This example shows the many ways you can deploy Helm Charts with Zarf. To learn more about how `charts` work in Zarf, see the [Helm Charts section](/v0.77/ref/components/#helm-charts) of the package components documentation.
  ...
  - name: demo-helm-charts
    ...
    charts:
      ...
      - name: podinfo-local
        ...
        valuesFiles:
          - values.yaml
        # serverSideApply is a new option in Helm 4
        # Can be set to true, false, and "auto". Defaults to "auto" which uses SSA on new installs, and automatically selects the previously apply method on upgrade
