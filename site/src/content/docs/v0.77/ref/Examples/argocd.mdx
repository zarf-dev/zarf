---
title: argocd
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/argocd/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/argocd
---

:::note
To view the full example, as well as its dependencies, please visit [examples/argocd](https://github.com/zarf-dev/zarf/tree/main/examples/argocd).
:::
