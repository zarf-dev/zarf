---
title: wordpress
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/wordpress/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/wordpress
---

:::note
To view the full example, as well as its dependencies, please visit [examples/wordpress](https://github.com/zarf-dev/zarf/tree/main/examples/wordpress).
:::

This example demonstrates how to use Zarf to deploy a WordPress blog into a cluster.

It is used as a part of the [Creating a Zarf Package](/v0.77/tutorials/0-creating-a-zarf-package/) and [Deploying a Zarf Package](/v0.77/tutorials/2-deploying-zarf-packages/) tutorials.
