---
title: yolo
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/yolo/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/yolo
---

:::note
To view the full example, as well as its dependencies, please visit [examples/yolo](https://github.com/zarf-dev/zarf/tree/main/examples/yolo).
:::
