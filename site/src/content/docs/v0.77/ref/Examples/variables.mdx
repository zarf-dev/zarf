---
title: variables
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/variables/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/variables
---

:::note
To view the full example, as well as its dependencies, please visit [examples/variables](https://github.com/zarf-dev/zarf/tree/main/examples/variables).
:::
...
variables:
  ...
  - name: MODIFIED_CONFIG
    ...
    sensitive: true
    type: file
  # EXTRA_DATA demonstrates a multi-line variable substituted as the sole entry under a YAML
  # mapping key (see nginx-extra-configmap.yaml). Also serves as regression coverage for #4863.
  - name: EXTRA_DATA
    default: |
