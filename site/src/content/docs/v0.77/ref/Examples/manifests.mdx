---
title: manifests
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/manifests/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/manifests
---

:::note
To view the full example, as well as its dependencies, please visit [examples/manifests](https://github.com/zarf-dev/zarf/tree/main/examples/manifests).
:::
...
To learn more about how `manifests` work in Zarf, see the [Kubernetes Manifests section](/v0.77/ref/components/#kubernetes-manifests) of the package components documentation.
