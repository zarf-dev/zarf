---
title: longhorn
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/longhorn/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/longhorn
---

:::note
To view the full example, as well as its dependencies, please visit [examples/longhorn](https://github.com/zarf-dev/zarf/tree/main/examples/longhorn).
:::
