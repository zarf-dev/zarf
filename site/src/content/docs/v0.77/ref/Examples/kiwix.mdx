---
title: kiwix
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/kiwix/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/kiwix
---

:::note
To view the full example, as well as its dependencies, please visit [examples/kiwix](https://github.com/zarf-dev/zarf/tree/main/examples/kiwix).
:::
