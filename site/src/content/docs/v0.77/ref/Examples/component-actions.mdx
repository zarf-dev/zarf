...
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/component-actions/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/component-actions
---

:::note
To view the full example, as well as its dependencies, please visit [examples/component-actions](https://github.com/zarf-dev/zarf/tree/main/examples/component-actions).
:::
...
For more details on component actions, see the [component actions](/v0.77/ref/actions/) documentation.
