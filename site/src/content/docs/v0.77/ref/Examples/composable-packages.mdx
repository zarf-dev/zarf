...
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/composable-packages/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/composable-packages
---

:::note
To view the full example, as well as its dependencies, please visit [examples/composable-packages](https://github.com/zarf-dev/zarf/tree/main/examples/composable-packages).
:::
