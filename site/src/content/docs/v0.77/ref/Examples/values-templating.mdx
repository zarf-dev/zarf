...
editURL: https://github.com/zarf-dev/zarf/edit/main/examples/values-templating/readme.md
description: ""
tableOfContents: false
slug: v0.77/ref/examples/values-templating
---

:::note
To view the full example, as well as its dependencies, please visit [examples/values-templating](https://github.com/zarf-dev/zarf/tree/main/examples/values-templating).
:::
