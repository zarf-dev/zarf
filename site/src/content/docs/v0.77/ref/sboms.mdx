...
![SBOM Prompt](../../../../assets/dashboard/v0.77/SBOM-prompt-example.png)
...
To learn more about the formats Syft supports see [`zarf tools sbom convert`](/v0.77/commands/zarf_tools_sbom_convert).

## The SBOM Viewer

![SBOM Dashboard](../../../../assets/dashboard/v0.77/SBOM-dashboard.png)
...
![SBOM Comparer](../../../../assets/dashboard/v0.77/SBOM-compare.png)
