...
> command: [`zarf tools yq`](/v0.77/commands/zarf_tools_yq)
>
> aliases: `yq`
...
> command: [`zarf tools archiver`](/v0.77/commands/zarf_tools_archiver)
>
> aliases: `archiver`, `a`

Zarf uses the great [mholt/archives](https://github.com/mholt/archives) library as a dependency to create and extract archives. This library also offers itself as a standalone tool that can be used to create and extract archives.

## syft

> command: [`zarf tools sbom`](/v0.77/commands/zarf_tools_sbom)
>
> aliases: `syft`, `sbom`, `s`
...
> command: [`zarf tools k9s`](/v0.77/commands/zarf_tools_monitor)
>
...
![k9s dashboard](../../../../assets/dashboard/v0.77/k9s_dashboard_example.png)
