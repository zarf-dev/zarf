...
sidebar:
  order: 85
slug: v0.77/ref/package-signing
---
...
* [zarf package sign](/v0.77/commands/zarf_package_sign/) - Sign a Zarf package
* [zarf package verify](/v0.77/commands/zarf_package_verify/) - Verify a package signature
* [zarf package create](/v0.77/commands/zarf_package_create/) - Create a package with optional signing
* [zarf tools gen-key](/v0.77/commands/zarf_tools_gen-key/) - Generate a signing key pair
...
* [Package Signing Tutorial](/v0.77/tutorials/5-package-signing-and-verification/)
