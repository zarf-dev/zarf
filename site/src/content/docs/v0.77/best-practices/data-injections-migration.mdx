...
slug: v0.77/best-practices/data-injections-migration
---
...
:::tip
Some registries will not accept images over a certain size or you may want to avoid pushing your data to a connected registry. To build the package with a local image use [Image Archives](/v0.77/ref/components#container-image-archives). The [Kiwix example](/v0.77/ref/examples/kiwix) uses this strategy
:::
