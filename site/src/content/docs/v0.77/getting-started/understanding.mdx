...
slug: v0.77/getting-started/understanding
---
...
* [**Zarf Package**](/v0.77/ref/packages) - A binary file that contains the instructions and dependencies necessary to install an application on a system.
* [**Zarf Component**](/v0.77/ref/components) - A set of defined functionality and resources that build up a package.
* [**Zarf Init Package**](/v0.77/ref/init-package) - The initial package that lays the groundwork for other packages.
:::
...
* **Air-gapped systems**:  Systems are designed to operate while *physically disconnected* from "unsecured" networks like the internet. For more information, see [Air Gap Networking](https://en.wikipedia.org/wiki/Air_gap_\(networking\)).
