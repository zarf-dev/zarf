...
slug: v0.77/getting-started/install
---
...
* `asdf install` with the [ASDF Version Manager](https://github.com/defenseunicorns-labs/asdf-zarf)
...
* `conda install` with [conda-forge](https://anaconda.org/conda-forge/zarf)
...
:::tip
You can build your own custom 'init' package too if you'd like. For this you should check out the [Creating a Custom 'init' Package Tutorial](/v0.77/tutorials/7-custom-init-packages).
:::
