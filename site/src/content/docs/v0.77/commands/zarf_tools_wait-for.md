...
slug: v0.77/commands/zarf_tools_wait-for
---
...
* [zarf tools wait-for network](/v0.77/commands/zarf_tools_wait-for_network/)	 - Waits for a network endpoint to meet the condition
* [zarf tools wait-for resource](/v0.77/commands/zarf_tools_wait-for_resource/)	 - Waits for a given Kubernetes resource to be fully reconciled
