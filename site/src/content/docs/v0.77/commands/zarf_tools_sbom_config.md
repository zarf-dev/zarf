...
slug: v0.77/commands/zarf_tools_sbom_config
---
...
* [zarf tools sbom config locations](/v0.77/commands/zarf_tools_sbom_config_locations/)	 - shows all locations and the order in which syft will look for a configuration file
