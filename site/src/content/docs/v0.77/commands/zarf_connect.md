...
slug: v0.77/commands/zarf_connect
---
...
Uses a k8s port-forward to connect to resources within the cluster.
...
* [zarf connect list](/v0.77/commands/zarf_connect_list/)	 - Lists all available connection shortcuts
* [zarf connect resource](/v0.77/commands/zarf_connect_resource/)	 - Connect to a service or pod in the cluster
