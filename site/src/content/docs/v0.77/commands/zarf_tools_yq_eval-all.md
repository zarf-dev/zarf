---
title: zarf tools yq eval-all
description: Zarf CLI command reference for <code>zarf tools yq eval-all</code>.
tableOfContents: false
slug: v0.77/commands/zarf_tools_yq_eval-all
---

## zarf tools yq eval-all
...
This command loads *all* yaml documents of *all* yaml files and runs expression once
...
```
zarf tools yq eval-all [expression] [yaml_file1]... [flags]
```
