...
slug: v0.77/commands/zarf_tools_yq
---
...
* [zarf tools yq eval](/v0.77/commands/zarf_tools_yq_eval/)	 - (default) Apply the expression to each document in each yaml file in sequence
* [zarf tools yq eval-all](/v0.77/commands/zarf_tools_yq_eval-all/)	 - Loads *all* yaml documents of *all* yaml files and runs expression once
