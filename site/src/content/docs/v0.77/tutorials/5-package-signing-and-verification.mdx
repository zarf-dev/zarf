...
sidebar:
  order: 5
slug: v0.77/tutorials/5-package-signing-and-verification
---
...
:::note
For a comprehensive reference on signing methods, signature formats, and advanced use cases, see the [Package Signing Reference](/v0.77/ref/package-signing/).
:::
...
Finally, we'll deploy the package with signature verification enabled. If you have a Kubernetes cluster initialized (see [Initializing a K8s Cluster](/v0.77/tutorials/1-initializing-a-k8s-cluster/)), you can deploy:
...
* Learn about signing existing packages with `zarf package sign` in the [Package Signing Reference](/v0.77/ref/package-signing/)
* Explore cloud KMS options for production signing in the [Package Signing Reference](/v0.77/ref/package-signing/#cloud-key-management-services-kms)
...
* [Package Signing Reference](/v0.77/ref/package-signing/) - Comprehensive signing and verification documentation
* [zarf package sign command](/v0.77/commands/zarf_package_sign/) - Command reference
* [zarf package verify command](/v0.77/commands/zarf_package_verify/) - Command reference
