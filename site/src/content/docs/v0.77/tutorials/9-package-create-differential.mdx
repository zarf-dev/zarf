...
sidebar:
  order: 10
slug: v0.77/tutorials/9-package-create-differential
---
...
In this example we're going to use the [Longhorn Example](/v0.77/ref/examples/longhorn/) to create a differential package.
...
<iframe src="/tutorials/differential_package_create.html" width="100%" height="600px" />
...
<iframe src="/tutorials/differential_package_error.html" width="100%" height="180px" />
:::

<iframe src="/tutorials/differential_package_edit.html" width="100%" height="600px" />
...
<iframe src="/tutorials/differential_package_create_differential.html" width="100%" height="600px" />
...
<iframe src="/tutorials/differential_package_create_conclusion.html" width="100%" height="600px" />
