...
sidebar:
  order: 5
slug: v0.77/tutorials/4-creating-a-k8s-cluster-with-zarf
---
...
* An init-package built/downloaded: ([init-package Build Instructions](/v0.77/tutorials/0-creating-a-zarf-package/)) or ([Download Location](https://github.com/zarf-dev/zarf/releases))
...
<iframe src="/tutorials/k3s_init.html" height="750px" width="100%" />
...
The [`zarf destroy`](/v0.77/commands/zarf_destroy/) command will remove all of the resources, including the k3s cluster, that was created by the initialization command.
