...
sidebar:
  order: 3
slug: v0.77/tutorials/3-deploy-a-retro-arcade
---

## Introduction

In previous tutorials, we learned how to [create a package](/v0.77/tutorials/0-creating-a-zarf-package/), [initialize a cluster](/v0.77/tutorials/1-initializing-a-k8s-cluster/), and [deploy a package](/v0.77/tutorials/2-deploying-zarf-packages/). In this tutorial, we will leverage all that past work and deploy a fun application onto your cluster.
...
:::tip
You can publish your own packages for deployment too via `oci://`.  See the [Store and Deploy Packages with OCI](/v0.77/tutorials/6-publish-and-deploy/) tutorial for more information.
:::

<iframe src="/tutorials/package_deploy_deploy.html" width="100%" height="595px" />
...
<iframe src="/tutorials/package_deploy_deploy_bottom.html" width="100%" height="400px" />
...
<iframe src="/tutorials/package_deploy_connect.html" width="100%" />

![Connected to the Games](../../../../assets/tutorials/v0.77/games_connected.png)
...
<iframe src="/tutorials/package_deploy_list.html" height="120px" width="100%" />
...
<iframe src="/tutorials/package_deploy_remove_no_confirm.html" width="100%" height="425px" />
...
<iframe src="/tutorials/package_deploy_remove_by_file.html" height="100px" width="100%" />
...
:::note[Remediation]
If you receive this error when zarf is attempting to deploy the `BASELINE COMPONENT`, this means you have not initialized the kubernetes cluster.  This is one of the prerequisites for this tutorial.  Perform the [Initialize a cluster](/v0.77/tutorials/1-initializing-a-k8s-cluster/) tutorial, then try again.
:::
...
* [reddit.com/r/programming/comments/nap4pt/dos\_gaming\_in\_docker](https://www.reddit.com/r/programming/comments/nap4pt/dos_gaming_in_docker/)
