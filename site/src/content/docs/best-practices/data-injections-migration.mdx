...
If your cluster supports OCI volume sources (GA in Kubernetes 1.35+, Zarf v0.69.1+), the read-only volume approach is recommended. Otherwise, use the init container approach.
