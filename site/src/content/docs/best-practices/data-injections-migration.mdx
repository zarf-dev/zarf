...
This guide explains how to migrate your Zarf deployment from the data injections feature to OCI image-based data delivery methods. Data injections is deprecated in the current Zarf schema version will be fully removed from the next schema version. There are for several reasons behind this:
