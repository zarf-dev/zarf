...
- **Deploy:** Init Packages can also be deployed directly with `package deploy` - allowing for explicit deployment specification and the use of [custom init packages](/tutorials/07-custom-init-packages).
