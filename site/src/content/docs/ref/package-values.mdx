...
{/* FIXME, link to a short section about sprig functions */}
- Leverage Go's templating engine for advanced transformations and use functions using [Sprig](/ref/templating/)
