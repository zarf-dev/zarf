...
Keyless signature verification is currently only supported via `zarf package verify`. Verification during `zarf package deploy` and other commands is not yet available. Track progress in [#4943](https://github.com/zarf-dev/zarf/issues/4943).
