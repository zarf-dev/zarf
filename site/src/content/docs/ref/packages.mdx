...
Package consumers can extract documentation using the command [zarf package inspect documentation](/commands/zarf_package_inspect_documentation). View an example of the `documentation` field in the [dos-games](/ref/examples/dos-games) package.
