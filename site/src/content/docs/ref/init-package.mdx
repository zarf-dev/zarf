...
5. The registry Deployment and Proxy Daemonset point their images to the Zarf Injector Daemonset, which is also exposed through a host port or host network proxy. This allows the kubelet to pull these images.
