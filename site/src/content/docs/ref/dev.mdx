...
:::note
The location of the schema file changed in Zarf v0.39.0. To set the language server to a specific version before v0.39.0 use https://raw.githubusercontent.com/zarf-dev/zarf/{VERSION}/zarf.schema.json
:::
