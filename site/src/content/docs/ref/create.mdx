...
graph TD
    ...
    subgraph  ""
    A13(add each component)-->A13_loop
    A13_loop-->A13
    ...
    A19(load '.repos')-->A20
    A20(run each '.actions.onCreate.after'):::action-->A20_loop
    A20_loop --> A20
    A20-->A21{Success?}
    ...
    classDef hiddenNode fill:none,stroke:none;
    class A13_loop hiddenNode;
    class A20_loop hiddenNode;
`}/>
</Details>
