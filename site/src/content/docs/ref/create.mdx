...
Templates are used during `zarf package create` to parameterize the `zarf.yaml` file. Templates are baked into the Zarf package meaning they cannot be changed post create.
