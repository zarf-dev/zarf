...
package, reducing its size. This is especially useful in environments where large data transfers are costly or time-consuming. View the [Differential Package Tutorial](/tutorials/09-package-create-differential) for an example.
