...
- made executable by setting `Executable` boolean value [true|false]
...
Images can either be discovered manually, or automatically by using [`zarf dev find-images`](/commands/zarf_dev_find-images/).
