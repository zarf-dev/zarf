...
Data injections are deprecated and will be removed in the next schema version. Please migrate to using OCI image-based data delivery instead. See the [Data Injections Migration Guide](/best-practices/data-injections-migration/) for migration instructions.
