...
## Youtube Tutorial
[![Using OCI to Store & Deploy Zarf Packages Video on YouTube](../../../assets/tutorials/publish_and_deploy_thumbnail.png)](https://www.youtube.com/watch?v=QKxgJnC_37Y "Using OCI to Store & Deploy Zarf Packages")
