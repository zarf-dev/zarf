...
- Access to a cluster that has been [initialized with zarf](/tutorials/01-initializing-a-k8s-cluster/).
...
If you receive this error when zarf is attempting to deploy any component, this means you have not initialized the kubernetes cluster.  This is one of the prerequisites for this tutorial.  Perform the [Initialize a cluster](/tutorials/01-initializing-a-k8s-cluster/) tutorial, then try again.
