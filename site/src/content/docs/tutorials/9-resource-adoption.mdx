...
## Youtube Tutorial
[![Tutorial: Adopt Pre-Existing Resources to Manage with Zarf](../../../assets/tutorials/adoption_thumbnail.png)](https://youtu.be/r3TBpMXtuNY "Adopt Pre-Existing Resources to Manage with Zarf")
