...
Congratulations! You've built the WordPress package. Now, you can learn how to [inspect the SBOMs](/ref/sboms/#viewing-a-packages-sbom) or head straight to [deploying it](/tutorials/02-deploying-zarf-packages/)!
