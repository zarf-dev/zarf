...
Deploy with signature verification enabled. If you have an initialized Kubernetes cluster, see [Initializing a K8s Cluster](/tutorials/01-initializing-a-k8s-cluster/), then run:
