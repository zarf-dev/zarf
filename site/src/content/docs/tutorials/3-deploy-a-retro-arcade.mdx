...
You can publish your own packages for deployment too via `oci://`.  See the [Store and Deploy Packages with OCI](/tutorials/7-publish-and-deploy/) tutorial for more information.
