...
1. Tests in the [src/cmd](https://github.com/zarf-dev/zarf/tree/main/src/cmd) package, which test an entire command. These are similar to e2e tests, but have faster iteration loops.
