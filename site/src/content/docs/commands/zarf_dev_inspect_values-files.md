...
```
  ...
  -h, --help                                  help for values-files
      ...
      --set-values stringArray                Specify deployment package values to set on the command line (key.path=value). Values are type-inferred: true/false become booleans and whole numbers become integers, everything else stays a string
