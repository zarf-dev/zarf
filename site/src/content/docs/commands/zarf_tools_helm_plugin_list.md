---
title: zarf tools helm plugin list
description: Zarf CLI command reference for <code>zarf tools helm plugin list</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools helm plugin list

list installed Helm plugins

```
zarf tools helm plugin list [flags]
```
