---
title: zarf tools kubectl rollout history
description: Zarf CLI command reference for <code>zarf tools kubectl rollout history</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl rollout history
...
```
zarf tools kubectl rollout history (TYPE NAME | TYPE/NAME) [flags]
```
