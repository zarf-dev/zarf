---
title: zarf tools kubectl rollout undo
description: Zarf CLI command reference for <code>zarf tools kubectl rollout undo</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl rollout undo
...
```
zarf tools kubectl rollout undo (TYPE NAME | TYPE/NAME) [flags]
```
