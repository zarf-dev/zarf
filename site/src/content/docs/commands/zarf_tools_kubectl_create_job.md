---
title: zarf tools kubectl create job
description: Zarf CLI command reference for <code>zarf tools kubectl create job</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create job
...
```
zarf tools kubectl create job NAME --image=image [--from=cronjob/name] -- [COMMAND] [args...]
```
