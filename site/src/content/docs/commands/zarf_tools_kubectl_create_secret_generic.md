---
title: zarf tools kubectl create secret generic
description: Zarf CLI command reference for <code>zarf tools kubectl create secret generic</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create secret generic
...
```
zarf tools kubectl create secret generic NAME [--type=string] [--from-file=[key=]source] [--from-literal=key1=value1] [--dry-run=server|client|none]
```
