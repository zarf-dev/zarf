---
title: zarf tools kubectl apply edit-last-applied
description: Zarf CLI command reference for <code>zarf tools kubectl apply edit-last-applied</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl apply edit-last-applied
...
```
zarf tools kubectl apply edit-last-applied (RESOURCE/NAME | -f FILENAME)
```
