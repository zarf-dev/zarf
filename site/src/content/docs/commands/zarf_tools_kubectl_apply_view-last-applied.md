---
title: zarf tools kubectl apply view-last-applied
description: Zarf CLI command reference for <code>zarf tools kubectl apply view-last-applied</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl apply view-last-applied
...
```
zarf tools kubectl apply view-last-applied (TYPE [NAME | -l label] | TYPE/NAME | -f FILENAME)
```
