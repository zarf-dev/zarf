---
title: zarf tools kubectl api-resources
description: Zarf CLI command reference for <code>zarf tools kubectl api-resources</code>.
...
```
zarf tools kubectl api-resources [flags]
```
