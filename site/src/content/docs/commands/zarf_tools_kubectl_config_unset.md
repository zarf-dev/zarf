---
title: zarf tools kubectl config unset
description: Zarf CLI command reference for <code>zarf tools kubectl config unset</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl config unset
...
```
zarf tools kubectl config unset PROPERTY_NAME
```
