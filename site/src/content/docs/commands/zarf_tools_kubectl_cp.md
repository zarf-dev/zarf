---
title: zarf tools kubectl cp
description: Zarf CLI command reference for <code>zarf tools kubectl cp</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl cp
...
```
zarf tools kubectl cp <file-spec-src> <file-spec-dest>
```
