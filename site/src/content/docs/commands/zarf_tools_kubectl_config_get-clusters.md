---
title: zarf tools kubectl config get-clusters
description: Zarf CLI command reference for <code>zarf tools kubectl config get-clusters</code>.
...
```
zarf tools kubectl config get-clusters [flags]
```
