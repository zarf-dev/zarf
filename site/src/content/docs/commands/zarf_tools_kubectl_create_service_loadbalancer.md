---
title: zarf tools kubectl create service loadbalancer
description: Zarf CLI command reference for <code>zarf tools kubectl create service loadbalancer</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create service loadbalancer
...
```
zarf tools kubectl create service loadbalancer NAME [--tcp=port:targetPort] [--dry-run=server|client|none]
```
