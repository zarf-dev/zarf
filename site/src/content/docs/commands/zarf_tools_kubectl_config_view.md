---
title: zarf tools kubectl config view
description: Zarf CLI command reference for <code>zarf tools kubectl config view</code>.
...
```
zarf tools kubectl config view [flags]
```
