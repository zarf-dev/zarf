---
title: zarf tools kubectl config use-context
description: Zarf CLI command reference for <code>zarf tools kubectl config use-context</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl config use-context
...
```
zarf tools kubectl config use-context CONTEXT_NAME
```
