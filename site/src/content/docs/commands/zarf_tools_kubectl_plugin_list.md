---
title: zarf tools kubectl plugin list
description: Zarf CLI command reference for <code>zarf tools kubectl plugin list</code>.
...
```
zarf tools kubectl plugin list [flags]
```
