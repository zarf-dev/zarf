---
title: zarf tools helm get values
description: Zarf CLI command reference for <code>zarf tools helm get values</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools helm get values
...
```
zarf tools helm get values RELEASE_NAME [flags]
```
