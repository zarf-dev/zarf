---
title: zarf tools kubectl create priorityclass
description: Zarf CLI command reference for <code>zarf tools kubectl create priorityclass</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create priorityclass
...
```
zarf tools kubectl create priorityclass NAME --value=VALUE --global-default=BOOL [--dry-run=server|client|none]
```
