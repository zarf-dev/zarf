---
title: zarf tools kubectl config delete-user
description: Zarf CLI command reference for <code>zarf tools kubectl config delete-user</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl config delete-user
...
```
zarf tools kubectl config delete-user NAME
```
