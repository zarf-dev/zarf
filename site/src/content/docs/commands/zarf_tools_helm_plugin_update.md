---
title: zarf tools helm plugin update
description: Zarf CLI command reference for <code>zarf tools helm plugin update</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools helm plugin update

update one or more Helm plugins

```
zarf tools helm plugin update <plugin>... [flags]
```
