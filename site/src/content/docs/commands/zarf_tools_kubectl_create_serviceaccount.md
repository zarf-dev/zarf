---
title: zarf tools kubectl create serviceaccount
description: Zarf CLI command reference for <code>zarf tools kubectl create serviceaccount</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create serviceaccount
...
```
zarf tools kubectl create serviceaccount NAME [--dry-run=server|client|none]
```
