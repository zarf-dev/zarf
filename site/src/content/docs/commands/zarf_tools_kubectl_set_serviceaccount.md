---
title: zarf tools kubectl set serviceaccount
description: Zarf CLI command reference for <code>zarf tools kubectl set serviceaccount</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl set serviceaccount
...
```
zarf tools kubectl set serviceaccount (-f FILENAME | TYPE NAME) SERVICE_ACCOUNT
```
