---
title: zarf tools kubectl attach
description: Zarf CLI command reference for <code>zarf tools kubectl attach</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl attach
...
```
zarf tools kubectl attach (POD | TYPE/NAME) -c CONTAINER
```
