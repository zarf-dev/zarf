---
title: zarf tools kubectl certificate approve
description: Zarf CLI command reference for <code>zarf tools kubectl certificate approve</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl certificate approve
...
```
zarf tools kubectl certificate approve (-f FILENAME | NAME)
```
