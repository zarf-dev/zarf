---
title: zarf tools kubectl auth reconcile
description: Zarf CLI command reference for <code>zarf tools kubectl auth reconcile</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl auth reconcile
...
```
zarf tools kubectl auth reconcile -f FILENAME
```
