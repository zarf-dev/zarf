---
title: zarf tools kubectl cluster-info
description: Zarf CLI command reference for <code>zarf tools kubectl cluster-info</code>.
...
```
zarf tools kubectl cluster-info [flags]
```
...
* [zarf tools kubectl cluster-info dump](/commands/zarf_tools_kubectl_cluster-info_dump/)	 - Dump relevant information for debugging and diagnosis
