---
title: zarf tools kubectl create quota
description: Zarf CLI command reference for <code>zarf tools kubectl create quota</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create quota
...
```
zarf tools kubectl create quota NAME [--hard=key1=value1,key2=value2] [--scopes=Scope1,Scope2] [--dry-run=server|client|none]
```
