---
title: zarf tools helm verify
description: Zarf CLI command reference for <code>zarf tools helm verify</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools helm verify
...
```
zarf tools helm verify PATH [flags]
```
