---
title: zarf tools kubectl autoscale
description: Zarf CLI command reference for <code>zarf tools kubectl autoscale</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl autoscale
...
```
zarf tools kubectl autoscale (-f FILENAME | TYPE NAME | TYPE/NAME) [--min=MINPODS] --max=MAXPODS [--cpu=CPU] [--memory=MEMORY]
```
