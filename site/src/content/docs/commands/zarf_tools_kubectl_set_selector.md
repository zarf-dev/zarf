---
title: zarf tools kubectl set selector
description: Zarf CLI command reference for <code>zarf tools kubectl set selector</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl set selector
...
```
zarf tools kubectl set selector (-f FILENAME | TYPE NAME) EXPRESSIONS [--resource-version=version]
```
