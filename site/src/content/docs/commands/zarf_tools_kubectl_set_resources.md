---
title: zarf tools kubectl set resources
description: Zarf CLI command reference for <code>zarf tools kubectl set resources</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl set resources
...
```
zarf tools kubectl set resources (-f FILENAME | TYPE NAME)  ([--limits=LIMITS & --requests=REQUESTS]
```
...
```
  ...
  -c, --containers string              The names of containers in the selected pod templates to change, all containers are selected by default - may use wildcards
