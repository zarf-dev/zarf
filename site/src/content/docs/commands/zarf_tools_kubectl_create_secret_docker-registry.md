---
title: zarf tools kubectl create secret docker-registry
description: Zarf CLI command reference for <code>zarf tools kubectl create secret docker-registry</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create secret docker-registry
...
```
zarf tools kubectl create secret docker-registry NAME --docker-username=user --docker-password=password --docker-email=email [--docker-server=string] [--from-file=[key=]source] [--dry-run=server|client|none]
```
...
```
  ...
  zarf tools kubectl create secret docker-registry my-secret --docker-server=DOCKER_REGISTRY_SERVER --docker-username=DOCKER_USER --docker-password=DOCKER_PASSWORD --docker-email=DOCKER_EMAIL
  
  # Create a new secret named my-secret from ~/.docker/config.json
  zarf tools kubectl create secret docker-registry my-secret --from-file=path/to/.docker/config.json
```
