---
title: zarf tools kubectl certificate deny
description: Zarf CLI command reference for <code>zarf tools kubectl certificate deny</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl certificate deny
...
```
zarf tools kubectl certificate deny (-f FILENAME | NAME)
```
