---
title: zarf tools kubectl diff
description: Zarf CLI command reference for <code>zarf tools kubectl diff</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl diff
...
```
zarf tools kubectl diff -f FILENAME
```
