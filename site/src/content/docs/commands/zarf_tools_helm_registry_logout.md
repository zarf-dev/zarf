---
title: zarf tools helm registry logout
description: Zarf CLI command reference for <code>zarf tools helm registry logout</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools helm registry logout
...
```
zarf tools helm registry logout [host] [flags]
```
