---
title: zarf tools helm upgrade
description: Zarf CLI command reference for <code>zarf tools helm upgrade</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools helm upgrade
...
```
zarf tools helm upgrade [RELEASE] [CHART] [flags]
```
