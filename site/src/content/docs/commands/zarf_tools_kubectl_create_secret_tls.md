---
title: zarf tools kubectl create secret tls
description: Zarf CLI command reference for <code>zarf tools kubectl create secret tls</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create secret tls
...
```
zarf tools kubectl create secret tls NAME --cert=path/to/cert/file --key=path/to/key/file [--dry-run=server|client|none]
```
