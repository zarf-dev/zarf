---
title: zarf tools helm get metadata
description: Zarf CLI command reference for <code>zarf tools helm get metadata</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools helm get metadata

This command fetches metadata for a given release

```
zarf tools helm get metadata RELEASE_NAME [flags]
```
