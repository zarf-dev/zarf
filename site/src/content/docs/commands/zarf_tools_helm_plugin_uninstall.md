---
title: zarf tools helm plugin uninstall
description: Zarf CLI command reference for <code>zarf tools helm plugin uninstall</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools helm plugin uninstall

uninstall one or more Helm plugins

```
zarf tools helm plugin uninstall <plugin>... [flags]
```
