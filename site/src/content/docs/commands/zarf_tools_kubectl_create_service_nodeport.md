---
title: zarf tools kubectl create service nodeport
description: Zarf CLI command reference for <code>zarf tools kubectl create service nodeport</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create service nodeport
...
```
zarf tools kubectl create service nodeport NAME [--tcp=port:targetPort] [--dry-run=server|client|none]
```
