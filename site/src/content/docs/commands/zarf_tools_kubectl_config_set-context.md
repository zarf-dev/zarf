---
title: zarf tools kubectl config set-context
description: Zarf CLI command reference for <code>zarf tools kubectl config set-context</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl config set-context
...
```
zarf tools kubectl config set-context [NAME | --current] [--cluster=cluster_nickname] [--user=user_nickname] [--namespace=namespace]
```
...
```
  ...
  -n, --namespace string   namespace for the context entry in kubeconfig
