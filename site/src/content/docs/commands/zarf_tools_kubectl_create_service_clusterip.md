---
title: zarf tools kubectl create service clusterip
description: Zarf CLI command reference for <code>zarf tools kubectl create service clusterip</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create service clusterip
...
```
zarf tools kubectl create service clusterip NAME [--tcp=<port>:<targetPort>] [--dry-run=server|client|none]
```
