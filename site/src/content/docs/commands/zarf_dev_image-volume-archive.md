...
```
  ...
  -c, --layer-compression string   Compression algorithm used on the individual layers of the image volume (default "gzip")
  ...
  -o, --output string              Path to write the resulting tar archive to (default derived from IMAGE-REFERENCE)
      --platform-os string         Operating system of the image volume (default "linux")
```
