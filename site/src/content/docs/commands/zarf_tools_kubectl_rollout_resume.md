---
title: zarf tools kubectl rollout resume
description: Zarf CLI command reference for <code>zarf tools kubectl rollout resume</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl rollout resume
...
```
zarf tools kubectl rollout resume RESOURCE
```
...
```
  ...
  zarf tools kubectl rollout resume deployment/nginx
```
