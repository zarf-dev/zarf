---
title: zarf tools kubectl create service externalname
description: Zarf CLI command reference for <code>zarf tools kubectl create service externalname</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create service externalname
...
```
zarf tools kubectl create service externalname NAME --external-name external.name [--dry-run=server|client|none]
```
