---
title: zarf tools kubectl config rename-context
description: Zarf CLI command reference for <code>zarf tools kubectl config rename-context</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl config rename-context
...
```
zarf tools kubectl config rename-context CONTEXT_NAME NEW_NAME
```
