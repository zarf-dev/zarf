---
title: zarf tools helm plugin verify
description: Zarf CLI command reference for <code>zarf tools helm plugin verify</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools helm plugin verify
...
```
zarf tools helm plugin verify [PATH] [flags]
```
