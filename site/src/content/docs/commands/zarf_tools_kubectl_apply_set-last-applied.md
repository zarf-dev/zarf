---
title: zarf tools kubectl apply set-last-applied
description: Zarf CLI command reference for <code>zarf tools kubectl apply set-last-applied</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl apply set-last-applied
...
```
zarf tools kubectl apply set-last-applied -f FILENAME
```
