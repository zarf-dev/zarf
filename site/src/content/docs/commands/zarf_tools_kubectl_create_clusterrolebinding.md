---
title: zarf tools kubectl create clusterrolebinding
description: Zarf CLI command reference for <code>zarf tools kubectl create clusterrolebinding</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create clusterrolebinding
...
```
zarf tools kubectl create clusterrolebinding NAME --clusterrole=NAME [--user=username] [--group=groupname] [--serviceaccount=namespace:serviceaccountname] [--dry-run=server|client|none]
```
