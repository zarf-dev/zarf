---
title: zarf tools kubectl create namespace
description: Zarf CLI command reference for <code>zarf tools kubectl create namespace</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create namespace
...
```
zarf tools kubectl create namespace NAME [--dry-run=server|client|none]
```
