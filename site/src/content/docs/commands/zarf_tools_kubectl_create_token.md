---
title: zarf tools kubectl create token
description: Zarf CLI command reference for <code>zarf tools kubectl create token</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create token
...
```
zarf tools kubectl create token SERVICE_ACCOUNT_NAME
```
