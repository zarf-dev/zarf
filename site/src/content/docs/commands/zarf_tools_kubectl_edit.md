---
title: zarf tools kubectl edit
description: Zarf CLI command reference for <code>zarf tools kubectl edit</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl edit
...
```
zarf tools kubectl edit (RESOURCE/NAME | -f FILENAME)
```
