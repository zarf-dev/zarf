---
title: zarf tools kubectl uncordon
description: Zarf CLI command reference for <code>zarf tools kubectl uncordon</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl uncordon
...
```
zarf tools kubectl uncordon NODE
```
