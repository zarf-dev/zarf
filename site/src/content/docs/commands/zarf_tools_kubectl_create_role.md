---
title: zarf tools kubectl create role
description: Zarf CLI command reference for <code>zarf tools kubectl create role</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create role
...
```
zarf tools kubectl create role NAME --verb=verb --resource=resource.group/subresource [--resource-name=resourcename] [--dry-run=server|client|none]
```
