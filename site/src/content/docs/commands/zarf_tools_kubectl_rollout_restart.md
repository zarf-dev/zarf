---
title: zarf tools kubectl rollout restart
description: Zarf CLI command reference for <code>zarf tools kubectl rollout restart</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl rollout restart
...
```
zarf tools kubectl rollout restart RESOURCE
```
