---
title: zarf tools kubectl plugin
description: Zarf CLI command reference for <code>zarf tools kubectl plugin</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl plugin
...
```
zarf tools kubectl plugin [flags]
```
...
* [zarf tools kubectl plugin list](/commands/zarf_tools_kubectl_plugin_list/)	 - List all visible plugin executables on a user's PATH
