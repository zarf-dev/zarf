---
title: zarf tools kubectl config get-users
description: Zarf CLI command reference for <code>zarf tools kubectl config get-users</code>.
...
```
zarf tools kubectl config get-users [flags]
```
