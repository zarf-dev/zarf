---
title: zarf tools kubectl config current-context
description: Zarf CLI command reference for <code>zarf tools kubectl config current-context</code>.
...
```
zarf tools kubectl config current-context [flags]
```
