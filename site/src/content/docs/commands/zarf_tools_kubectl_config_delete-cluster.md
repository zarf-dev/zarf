---
title: zarf tools kubectl config delete-cluster
description: Zarf CLI command reference for <code>zarf tools kubectl config delete-cluster</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl config delete-cluster
...
```
zarf tools kubectl config delete-cluster NAME
```
