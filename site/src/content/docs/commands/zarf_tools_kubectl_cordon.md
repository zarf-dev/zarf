---
title: zarf tools kubectl cordon
description: Zarf CLI command reference for <code>zarf tools kubectl cordon</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl cordon
...
```
zarf tools kubectl cordon NODE
```
