---
title: zarf tools kubectl proxy
description: Zarf CLI command reference for <code>zarf tools kubectl proxy</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl proxy
...
```
zarf tools kubectl proxy [--port=PORT] [--www=static-dir] [--www-prefix=prefix] [--api-prefix=prefix]
```
