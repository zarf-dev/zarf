---
title: zarf tools kubectl create cronjob
description: Zarf CLI command reference for <code>zarf tools kubectl create cronjob</code>.
tableOfContents: false
---

<!-- Page generated by Zarf; DO NOT EDIT -->

## zarf tools kubectl create cronjob
...
```
zarf tools kubectl create cronjob NAME --image=image --schedule='0/5 * * * ?' -- [COMMAND] [args...] [flags]
```
