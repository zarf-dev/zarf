---
title: "big-bang"
editURL: "https://github.com/defenseunicorns/zarf/edit/main/examples/big-bang/zarf.yaml"
description: ""
...
To view the full example, as well as its dependencies, please visit [examples/big-bang](https://github.com/defenseunicorns/zarf/tree/main/examples/big-bang).
...
To see a tutorial for the creation and deployment of this package see the [Big Bang Tutorial](/tutorials/6-big-bang.md).
...
You can learn about YOLO mode in the [FAQ](/faq#what-is-yolo-mode-and-why-would-i-use-it) or the [YOLO mode example](/examples/yolo/).

[Big Bang YOLO Mode Example](https://github.com/defenseunicorns/tree/main/examples/big-bang/yolo).
