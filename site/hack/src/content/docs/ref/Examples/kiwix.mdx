---
title: "kiwix"
editURL: "https://github.com/defenseunicorns/zarf/edit/main/examples/kiwix/zarf.yaml"
description: ""
...
To view the full example, as well as its dependencies, please visit [examples/kiwix](https://github.com/defenseunicorns/zarf/tree/main/examples/kiwix).
    ...
    actions:
      onCreate:
        before:
          ...
          - cmd: curl
              https://zarf-examples.s3.amazonaws.com/devops.stackexchange.com_en_all_2023-05.zim
