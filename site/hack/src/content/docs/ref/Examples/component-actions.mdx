...
editURL: "https://github.com/defenseunicorns/zarf/edit/main/examples/component-actions/zarf.yaml"
description: ""
...
To view the full example, as well as its dependencies, please visit [examples/component-actions](https://github.com/defenseunicorns/zarf/tree/main/examples/component-actions).
...
For more details on component actions, see the [component actions](/create-a-package/component-actions) documentation.
