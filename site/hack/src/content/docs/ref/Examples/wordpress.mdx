---
title: "wordpress"
editURL: "https://github.com/defenseunicorns/zarf/edit/main/examples/wordpress/zarf.yaml"
description: ""
...
To view the full example, as well as its dependencies, please visit [examples/wordpress](https://github.com/defenseunicorns/zarf/tree/main/examples/wordpress).

:::

This example demonstrates how to use Zarf to deploy a WordPress blog into a cluster.

It is used as a part of the [Creating a Zarf Package](../../docs/5-zarf-tutorials/0-creating-a-zarf-package.md) and [Deploying a Zarf Package](../../docs/5-zarf-tutorials/2-deploying-zarf-packages.md) tutorials.
