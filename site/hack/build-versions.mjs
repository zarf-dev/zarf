...
// Remove subtrees and assets left by a previous run. The `latest/` schemas and
...
// artifacts (examples, package snippets, schema). Content renders with the current toolchain.
