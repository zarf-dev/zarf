...
If your enterprise uses pull-through mirrors to host vetted images you can run the following to create a Zarf 'init' package from those mirrors (where `<registry>.enterprise.corp` is your enterprise mirror):
