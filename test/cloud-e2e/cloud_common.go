...
func NewCloudE2ETest(testing *testing.T) *CloudZarfE2ETest {
...
func (e2e *CloudZarfE2ETest) runSSHCommand(format string, a ...interface{}) (string, error) {
	command := fmt.Sprintf(format, a...)
	return ssh.CheckSshCommandE(e2e.testing, e2e.publicHost, command)
}

func (e2e *CloudZarfE2ETest) teardown() {
...
func (e2e *CloudZarfE2ETest) setup() {
...
func (e2e *CloudZarfE2ETest) configureTerraformOptions() (*terraform.Options, *aws.Ec2Keypair, error) {
...
func (e2e *CloudZarfE2ETest) syncFileToRemoteServer(srcPath string, destPath string, chmod string) {
	// Run `terraform output` to get the value of an output variable
