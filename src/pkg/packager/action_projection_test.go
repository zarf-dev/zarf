...
func TestProjectDeploymentComponents_AlphaActions(t *testing.T) {
	template := true
	timeout := 7
	retries := 2
...
func TestProjectDeploymentComponents_BetaActions(t *testing.T) {
	template := true
	timeout := int32(7)
	retries := int32(2)
...
func TestProjectDeploymentComponents_WaitDefaultsRemainVersionSpecific(t *testing.T) {
...
func TestProjectDeploymentComponents_PreservesExplicitWaitConditions(t *testing.T) {
