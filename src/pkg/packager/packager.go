...
// mergePackageValues applies CLI-provided overrides to already resolved package values.
func mergePackageValues(resolved, overrides value.Values) value.Values {
	vals := resolved.DeepCopy()
	if vals == nil {
		vals = value.Values{}
	}
