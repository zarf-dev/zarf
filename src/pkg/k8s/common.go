...
func NewK8sClientWithWait(logger K8sLog, labels K8sLabels, timeout time.Duration) (*K8sClient, error) {
	k, _ := NewK8sClient(logger, labels)
	return k, k.WaitForHealthyCluster(timeout)
}

func NewK8sClient(logger K8sLog, labels K8sLabels) (*K8sClient, error) {
