...
// ReplaceService deletes and re-creates a service based on the namespace and name of the service.
...
/*
GetServicesByLabel returns a list of services that matched the given a label and value.

To search all namespaces, pass "" in the namespace arg.
*/
...
/*
GetServicesByLabelExists returns a list of matched services given a label.
