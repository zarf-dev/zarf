...
// This function retries on cluster connection errors, allowing it to wait for a cluster to become available. This is to avoid a breaking change since it used to shell out to kubectl.
