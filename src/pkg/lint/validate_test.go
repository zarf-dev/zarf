...
func TestZarfPackageValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "duplicate documentation basenames",
			pkg: v1alpha1.ZarfPackage{
				Kind: v1alpha1.ZarfPackageConfig,
				Metadata: v1alpha1.ZarfMetadata{
				...
				Documentation: map[string]string{
					"readme1": "docs/README.md",
					"readme2": "other/README.md",
				},
			},
			expectedErrs: []string{
				fmt.Sprintf(PkgValidateErrDocumentationDuplicate, "README.md"),
			},
		},
	}
...
func TestValidateDocumentation(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "duplicate basename in different directories",
			documentation: map[string]string{
				"readme1": "docs/README.md",
				"readme2": "other/README.md",
			},
		...
		},
		{
			...
			expectedErrs: []string{
				fmt.Sprintf(PkgValidateErrDocumentationDuplicate, "GUIDE.md"),
				fmt.Sprintf(PkgValidateErrDocumentationDuplicate, "README.md"),
			},
		},
	}
