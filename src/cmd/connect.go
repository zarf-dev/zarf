...
func init() {
	...
	connectCmd.Flags().StringVar(&connectNamespace, "namespace", cluster.ZarfNamespace, "Specify the namespace.  E.g. namespace=default")
	connectCmd.Flags().StringVar(&connectResourceType, "type", cluster.SvcResource, "Specify the resource type.  E.g. type=svc or type=pod")
