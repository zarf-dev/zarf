...
func init() {
	...
	packageCreateCmd.Flags().BoolVar(&config.GlobalOptions.Confirm, "confirm", false, "Confirm package creation without prompting")
	packageCreateCmd.Flags().StringVar(&config.GlobalOptions.TempDirectory, "tmpdir", "", "Specify the temporary directory to use for intermediate files")
	...
	packageDeployCmd.Flags().BoolVar(&config.GlobalOptions.Confirm, "confirm", false, "Confirm package deployment without prompting")
	packageDeployCmd.Flags().StringVar(&config.GlobalOptions.TempDirectory, "tmpdir", "", "Specify the temporary directory to use for intermediate files")
	...
	packageInspectCmd.Flags().StringVar(&config.GlobalOptions.TempDirectory, "tmpdir", "", "Specify the temporary directory to use for intermediate files")
}
