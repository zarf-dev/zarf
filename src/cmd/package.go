...
func bindInspectFlags(v *viper.Viper) {
	...
	inspectFlags.StringVarP(&pkgConfig.PkgOpts.PublicKeyPath, "key", "k", v.GetString(common.VPkgInspectPublicKey), lang.CmdPackageFlagPublicKey)
}
...
func bindRemoveFlags(v *viper.Viper) {
	...
	removeFlags.StringVarP(&pkgConfig.PkgOpts.PublicKeyPath, "key", "k", v.GetString(common.VPkgRemovePublicKey), lang.CmdPackageFlagPublicKey)
