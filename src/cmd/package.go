...
func bindCreateFlags(v *viper.Viper) {
	...
	createFlags.StringVarP(&pkgConfig.CreateOpts.ExcludedComponents, "exclusions", "x", v.GetString(common.VPkgCreateExclusions), lang.CmdPackageCreateFlagExclusions)
