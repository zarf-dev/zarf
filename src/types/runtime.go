...
type ZarfDeployOptions struct {
	...
	ConfigVariables map[string]string `json:"configVariables" jsonschema:"description=Key-Value map of config variable names and their corresponding values that will be used to template against the Zarf package being used"`
}
