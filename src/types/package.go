...
type ZarfBuildData struct {
	...
	MinimumCompatibleVersion string            `json:"minimumCompatibleVersion,omitempty" jsonschema:"description=The minimum version of Zarf that can be used to successfully deploy a package"`
}
