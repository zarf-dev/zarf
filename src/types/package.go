...
type ZarfMetadata struct {
	...
	YOLO         bool   `json:"yolo,omitempty" jsonschema:"description=Yaml OnLy Online, this package contains no images or repos and can be deployed without a Zarf cluster (zarf init)."`
}
