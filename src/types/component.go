...
type ZarfComponent struct {
	...
	// Report Components
	Reports []ZarfComponentReport `json:"reports,omitempty" jsonschema:"description=Add static reports to component"`
}
...
// ZarfComponentReport structure for including reports
type ZarfComponentReport struct {
	Name   string `json:"name,omitempty"`
	Source string `json:"source" jsonschema:"description=The source to the data"`
