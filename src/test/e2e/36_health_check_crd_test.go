...
// TestHealthCheckCRDRegisteredMidDeploy guards against a regression where healthchecks
// don't recognize and wait against a crd that was introduced during package deploy
