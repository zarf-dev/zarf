...
func TestLint(t *testing.T) {
	...
	t.Run("zarf test lint fail", func(t *testing.T) {
		...
		require.Contains(t, strippedStderr, ".components.[0].images.[0] ghcr.io/defenseunicorns/packages/dos-games:1.0.0-skeleton: Image not pinned with digest defenseunicorns/zarf-game:multi-tile-dark")
	})
