...
func configFileDefaultTests(t *testing.T) {
	...
	globalFlags := []string{
		...
		"zarf_cache: 978499a5",
		"Allow access to insecure registries and disable other recommended security enforcements. This flag should only be used if you have a specific reason and accept the reduced security posture. (default true)",
		"tmp_dir: c457359e",
	}
