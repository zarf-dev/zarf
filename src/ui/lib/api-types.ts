...
export interface RawConfigClass {
	...
	extensions?: {
		[key: string]: any[] | boolean | number | number | { [key: string]: any } | null | string;
	};
	kind?: string;
...
const typeMap: any = {
	...
	ZarfComponent: o(
		[
			...
			{ json: 'cosignKeyPath', js: 'cosignKeyPath', typ: u(undefined, '') },
			{
				json: 'dataInjections',
				js: 'dataInjections',
				typ: u(undefined, a(r('ZarfDataInjection'))),
			},
	...
	ZarfComponentAction: o(
		[
			...
			{ json: 'setVariable', js: 'setVariable', typ: u(undefined, '') },
			{
				json: 'setVariables',
				js: 'setVariables',
				typ: u(undefined, a(r('ZarfComponentActionSetVariable'))),
			},
	...
	ZarfManifest: o(
		[
			...
			{
				json: 'kustomizeAllowAnyDirectory',
				js: 'kustomizeAllowAnyDirectory',
	...
	RawConfigClass: o(
		[
			...
			{ json: 'current-context', js: 'current-context', typ: '' },
			{
				json: 'extensions',
				js: 'extensions',
				typ: u(undefined, m(u(a('any'), true, 3.14, 0, m('any'), null, ''))),
			},
	...
	Cluster: o(
		[
			...
			{
				json: 'certificate-authority-data',
				js: 'certificate-authority-data',
				typ: u(undefined, ''),
			},
