...
const (
	...
	AgentErrParseProvider          = "failed to parse provider: %w"
	AgentErrParseFunction          = "failed to parse function: %w"
	AgentErrParseConfiguration     = "failed to parse configuration: %w"
