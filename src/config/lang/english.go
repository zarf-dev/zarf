...
$ zarf package pull oci://ghcr.io/zarf-dev/packages/dos-games:1.3.0 -a skeleton`
	...
	CmdDevFindImagesShort = "Evaluates components in a Zarf file to identify images specified in their helm charts, manifests."
	CmdDevFindImagesLong  = "Evaluates components in a Zarf file to identify images specified in their helm charts, manifests.\n\n" +
