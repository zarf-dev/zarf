...
var (
	...
	connectCmd = &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			// The cli flag was passed to block auto-open
			if !connectNoAutoOpen {
...
func init() {
	...
	connectCmd.Flags().BoolVar(&connectNoAutoOpen, "cli-only", false, "Disable browser auto-open")
}
