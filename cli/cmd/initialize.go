...
var initCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		k3s.Install(host, applianceMode, certPublicPath, certPrivatePath, confirmInit)
	},
}

func init() {
	rootCmd.AddCommand(initCmd)
	initCmd.Flags().BoolVar(&confirmInit, "confirm", false, "Confirm the install without prompting")
