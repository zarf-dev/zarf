...
- With [#329](https://github.com/defenseunicorns/zarf/pull/329), Zarf uses a new injector system to bootstrap a new cluster:
...
[Full SVG](./.images/architecture.svg) | [Source DrawIO](docs/zarf-injector.drawio)
