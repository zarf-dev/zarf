...
zarf tools kubectl apply -k http://zarf-git-user:$(zarf tools get-creds Git)@localhost:<WhicheverPortGotUsed>/zarf-git-user/mirror__github.com__stefanprodan__podinfo/kustomize
